...
form.addEventListener('submit', async (e) => {
  ...
  const v1 = validateField('firstName', 'firstNameError', 'First name is required.');
  const v2 = validateField('lastName', 'lastNameError', 'Last name is required.');
  const v3 = validateEmail('email', 'emailError');
  const v4 = validateField('subject', 'subjectError', 'Please select a subject.');
  ...
  // backend expects: { name, email, message } based on your contactRoutes.js
  const payload = {
